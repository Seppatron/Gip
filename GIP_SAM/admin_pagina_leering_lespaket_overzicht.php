...
<br>
<br>
  <h2>Leerling lespaket zoeken</h2>  
<br>
            ...
            <?php
                ...
                else 
                {
                    if(isset($_POST["search"]) && isset($_POST["leerling"]) && $_POST["leerling"] != "") 
                    {
                        ...
                        {
                            $sql = "SELECT l.id,l.naam,l.voornaam,l.postid,l.adres,l.email,l.telefoon,l.typegitaarid,l.genreid,g.PCode,g.PostcodeId,t.typeID,t.typegitaren,b.genreid,b.muziekgenre FROM tbllid l,tblgemeente g,tbltypes t,tblgenre b,tblespaket WHERE l.voornaam LIKE ? and l.postid=g.PostcodeId and l.typegitaarid=t.typeID and l.genreid=b.genreid ORDER BY l.id";
                        }
                        else 
                        {
                        ...
                        if($stmt = $mysqli->prepare($sql)) 
                        {
                            ...
                            else 
                            {
                                ...
                                while($stmt->fetch()) 
                                {
                                    echo "<tr><td>".$id."</td><td>". $voornaam ."</td><td>";
                    ?>
