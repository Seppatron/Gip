...
<head>
  ...
  <title>Sam De Troyer - Courses</title>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li class="active"><a href="courses.html">Lespakketten</a></li>
        ...
        <div class="row" data-aos="zoom-in" data-aos-delay="100">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="course-item">
              <img src="assets/img/strat-maple-neck-black.png" class="img-fluid" alt="...">
              <div class="course-content">
                ...
                <h3><a href="course-details.html">Jaarpakketten</a></h3>
                <p>Test test test.</p>
                <div class="trainer d-flex justify-content-between align-items-center">
                  <div class="trainer-profile d-flex align-items-center">
                    <img src="assets/img/sam.jpg" class="img-fluid" alt="">
                    <span>Sam</span>
                  </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
            <div class="course-item">
              ...
              <div class="course-content">
                <div class="d-flex justify-content-between align-items-center mb-3">
                  <h4>10 lespakketten</h4>
                  <p class="price">€80</p>
                </div>

                <h3><a href="course-details.html">10 lespakketten</a></h3>
                <p>.</p>
                <div class="trainer d-flex justify-content-between align-items-center">
                  <div class="trainer-profile d-flex align-items-center">
                    <img src="assets/img/sam.jpg" class="img-fluid" alt="">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
            <div class="course-item">
              ...
              <div class="course-content">
                <div class="d-flex justify-content-between align-items-center mb-3">
                  <h4>20 espakketten</h4>
                  <p class="price">€180</p>
                </div>

                <h3><a href="course-details.html">20 espakketten</a></h3>
                <p>Test test test.</p>
                <div class="trainer d-flex justify-content-between align-items-center">
                  <div class="trainer-profile d-flex align-items-center">
                    <img src="assets/img/sam.jpg" class="img-fluid" alt="">
