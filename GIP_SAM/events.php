...
<head>
  ...
  <title>Sam De Troyer - Events</title>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li class="active"><a href="events.html">Evenementen</a></li>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-md-6 d-flex align-items-stretch">
            <div class="card">
              <div class="card-img">
                <img src="assets/img/aaaaa%20sam%20op%20ment.jpg" alt="...">
              </div>
              <div class="card-body">
                <h5 class="card-title"><a href="">Evenement afgelast door covid-19</a></h5>
          ...
          <div class="col-md-6 d-flex align-items-stretch">
            <div class="card">
              <div class="card-img">
                <img src="assets/img/aa%20noch%20wa%20sam.jpg" alt="...">
              </div>
              <div class="card-body">
                <h5 class="card-title"><a href="">Evenement afgelast door covid-19</a></h5>
                <p class="font-italic text-center"> </p>
